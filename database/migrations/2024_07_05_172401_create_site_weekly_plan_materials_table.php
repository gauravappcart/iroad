...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('site_weekly_plan_materials', function (Blueprint $table) {
            $table->bigIncrements('site_weekly_plan_material_id');
            ...
            $table->tinyInteger('lhs_or_rhs_material')->nullable()->comment('1:lhs|2:rhs)');
    ...
    {
        Schema::dropIfExists('site_weekly_plan_materials');
    }
};
