...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2024 at 02:52 PM
...
--
-- Table structure for table `assign_materials`
--

CREATE TABLE `assign_materials` (
  `assign_material_id` bigint(20) UNSIGNED NOT NULL,
  `material_request_id` varchar(255) NOT NULL,
  `request_quantity` double(8,2) NOT NULL,
  `received_quantity` double(8,2) NOT NULL,
...
(105, '2024_08_08_174824_create_assign_materials_table', 71);
...
(1, 1, 'Super', 'Admin', 'admin@gmail.com', 'admin@gmail.com', NULL, 1, NULL, NULL, '$2y$10$HVII4qusmP59yQ.XEFLjzOOhfjn8CB2/aABLwdU0BrxM7RcpLG2I2', 'e414045581bfd2f48d9957c5e95f004b25e42219', '3edadbfd19233b7e3c90fab34c12388b129e5585d1dba34911f7218ae9c324c7', NULL, 0, 1, NULL, '2024-08-08 05:52:17', NULL),
...
--
-- Indexes for table `assign_materials`
--
ALTER TABLE `assign_materials`
  ADD PRIMARY KEY (`assign_material_id`);
...
--
-- AUTO_INCREMENT for table `assign_materials`
--
ALTER TABLE `assign_materials`
  MODIFY `assign_material_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
