...
(34, 2, 'CWIP-12-Asset  Machinery( 8th RDF)', '2021-12-21', 8, 5, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', '4500000', NULL, NULL, NULL, 1, 'HT 485', '2021-12-21', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '4500000', '7000000', '0', '31000000', NULL, '0', NULL, '31000000', NULL, '2024-08-05 06:46:01', '2024-08-05 06:46:01'),
(35, 2, 'CWIP-1233-Asset  Machinery( 8th RDF) 666', '2021-12-21', 8, 5, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', '4500000', NULL, NULL, NULL, 1, 'HT 485', '2021-12-21', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '4500000', '7000000', '0', '31000000', NULL, '0', NULL, '31000000', NULL, '2024-08-05 07:18:10', '2024-08-05 07:18:10');
...
CREATE TABLE `asset_requests` (
  `vehicle_types_request_id` bigint(20) UNSIGNED NOT NULL,
  `site_id` varchar(255) DEFAULT NULL,
  `component_id` varchar(255) DEFAULT NULL,
  `vehicle_types_id` int(11) DEFAULT NULL,
  `request_quantity` int(11) DEFAULT NULL,
  `working_hrs` double(8,2) DEFAULT NULL,
  `required_from_date` date DEFAULT NULL,
  `required_to_date` date DEFAULT NULL,
  `qc_comment` varchar(255) DEFAULT NULL,
  `received_status` varchar(255) DEFAULT NULL,
  `approved_by` varchar(255) DEFAULT NULL,
  `approved_quantity` tinyint(4) DEFAULT NULL,
  `approved_date` date DEFAULT NULL,
  `request_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0:Not Received|1:Received',
...
INSERT INTO `asset_requests` (`vehicle_types_request_id`, `site_id`, `component_id`, `vehicle_types_id`, `request_quantity`, `working_hrs`, `required_from_date`, `required_to_date`, `qc_comment`, `received_status`, `approved_by`, `approved_quantity`, `approved_date`, `request_status`, `is_active`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, '1', '1', 44, 2, 60.00, '2024-08-08', '2024-08-20', NULL, NULL, NULL, 0, NULL, 0, 1, '1', '1', NULL, '2024-08-08 05:53:01', '2024-08-08 05:53:01'),
(2, '1', '1', 41, 10, 100.00, '2024-08-08', '2024-08-16', NULL, NULL, NULL, 0, NULL, 0, 1, '1', '1', NULL, '2024-08-08 05:53:01', '2024-08-08 05:53:01');

-- --------------------------------------------------------

--
-- Table structure for table `assign_request_materials`
--

CREATE TABLE `assign_request_materials` (
  `assign_request_material_id` bigint(20) UNSIGNED NOT NULL,
  `material_request_id` varchar(255) NOT NULL,
  `request_quantity` double(8,2) NOT NULL,
  `received_quantity` double(8,2) DEFAULT NULL,
  `received_by` varchar(100) DEFAULT NULL,
  `received_date` date DEFAULT NULL,
  `qc_comment` varchar(255) DEFAULT NULL,
  `qty_approved` double(8,2) DEFAULT NULL,
  `approved_by` varchar(255) DEFAULT NULL,
  `approved_date` date DEFAULT NULL,
  `is_active` tinyint(4) NOT NULL DEFAULT 1,
  `created_by` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `assign_request_materials`
--

INSERT INTO `assign_request_materials` (`assign_request_material_id`, `material_request_id`, `request_quantity`, `received_quantity`, `received_by`, `received_date`, `qc_comment`, `qty_approved`, `approved_by`, `approved_date`, `is_active`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, '1', 50.00, 7.00, 'admin', '2024-08-09', NULL, NULL, NULL, NULL, 1, 'admin', 'admin', NULL, '2024-08-09 12:28:15', '2024-08-09 12:28:15');
...
--
-- Dumping data for table `conflicts_media`
--

INSERT INTO `conflicts_media` (`conflict_media_id`, `conflict_id`, `filename`, `filepath`, `fileurl`, `thumburl`, `filesize`, `created_by`, `updated_by`, `is_active`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, '1', 'full-bg.jpg', 'images/MFbGVlDoU2gukuu6kHsrBkXhTvjXUfMhA6fNgN9z.jpg', 'images/MFbGVlDoU2gukuu6kHsrBkXhTvjXUfMhA6fNgN9z.jpg', 'thumbnails/MFbGVlDoU2gukuu6kHsrBkXhTvjXUfMhA6fNgN9z.jpg', 0, NULL, NULL, NULL, NULL, '2024-08-02 07:28:25', '2024-08-02 07:28:25');
...
--
-- Table structure for table `labour_requests`
--

CREATE TABLE `labour_requests` (
  `labour_request_id` bigint(20) UNSIGNED NOT NULL,
  `site_id` varchar(255) DEFAULT NULL,
  `component_id` varchar(255) DEFAULT NULL,
  `labour_id` int(11) DEFAULT NULL,
  `labour_request_quantity` int(11) DEFAULT NULL,
  `working_hrs` double(8,2) DEFAULT NULL,
  `required_from` date DEFAULT NULL,
  `required_to` date DEFAULT NULL,
  `request_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0:Not Received|1:Received',
  `labour_approved` tinyint(4) DEFAULT 0,
  `approved_by` varchar(255) DEFAULT NULL,
  `is_active` tinyint(4) NOT NULL DEFAULT 1,
  `created_by` varchar(100) DEFAULT NULL,
  `updated_by` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `labour_requests`
--

INSERT INTO `labour_requests` (`labour_request_id`, `site_id`, `component_id`, `labour_id`, `labour_request_quantity`, `working_hrs`, `required_from`, `required_to`, `request_status`, `labour_approved`, `approved_by`, `is_active`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, '1', '1', 1, 30, 80.00, '2024-08-07', '2024-08-22', 0, 0, NULL, 1, '1', '1', NULL, '2024-08-07 06:53:15', '2024-08-07 06:53:15'),
(2, '1', '1', 2, 40, 60.30, '2024-08-07', '2024-08-11', 0, 0, NULL, 1, '1', '1', NULL, '2024-08-07 06:53:15', '2024-08-07 06:53:15');
...
(5, 1, 1, 'Super Crushed Silica', '7', '3', '2000', NULL, 1, '1', '1', '2023-01-05 08:33:58', '2024-07-23 06:15:37', NULL),
...
CREATE TABLE `material_requests` (
  ...
  `request_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0:Pending|1:Approved',
  `qty_approved` double(8,2) DEFAULT NULL,
  `approved_by` varchar(255) DEFAULT NULL,
  `approved_date` date DEFAULT NULL,
  `qty_received` double(8,2) DEFAULT NULL,
  `received_by` varchar(100) DEFAULT NULL,
  `received_date` date DEFAULT NULL,
  `site_id` varchar(255) DEFAULT NULL,
  `component_id` varchar(255) DEFAULT NULL,
  `received_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0:Not Received|1:Received',
  `qc_comment` varchar(255) DEFAULT NULL,
  `add_to_cart` tinyint(4) DEFAULT 0,
  `is_active` tinyint(4) NOT NULL DEFAULT 1,
  `created_by` varchar(100) DEFAULT NULL,
  `updated_by` varchar(100) DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `material_requests` (`material_request_id`, `request_quantity`, `material_type_id`, `material_id`, `request_status`, `qty_approved`, `approved_by`, `approved_date`, `qty_received`, `received_by`, `received_date`, `site_id`, `component_id`, `received_status`, `qc_comment`, `add_to_cart`, `is_active`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 50.00, '7', '5', 0, 0.00, '', '0000-00-00', 0.00, NULL, '0000-00-00', '1', '1', 0, NULL, 0, 1, '1', '1', NULL, '2024-08-07 04:35:35', '2024-08-07 04:35:35'),
(2, 40.00, '7', '8', 0, 0.00, '', '0000-00-00', 0.00, NULL, '0000-00-00', '1', '1', 0, NULL, 0, 1, '1', '1', NULL, '2024-08-07 04:35:35', '2024-08-07 04:35:35');
...
(102, '2024_08_06_172641_create_material_requests_table', 68),
(103, '2024_08_06_172705_create_labour_requests_table', 69),
(104, '2024_08_06_172056_create_asset_requests_table', 70),
(108, '2024_08_09_154327_create_assign_request_materials_table', 71);
...
(13, '1', '7', '5', '3', '1', '900', 'admin', 'admin', '1', NULL, '2024-07-16 09:06:20', '2024-08-09 12:28:15'),
...
(1, 1, 'Super', 'Admin', 'admin@gmail.com', 'admin@gmail.com', NULL, 1, NULL, NULL, '$2y$10$HVII4qusmP59yQ.XEFLjzOOhfjn8CB2/aABLwdU0BrxM7RcpLG2I2', 'acba2703dbcfe4b35e44eefa00655f6f4b73b21b', '3edadbfd19233b7e3c90fab34c12388b129e5585d1dba34911f7218ae9c324c7', NULL, 0, 1, NULL, '2024-08-09 10:47:50', NULL),
...
ALTER TABLE `asset_requests`
  ADD PRIMARY KEY (`vehicle_types_request_id`);

--
-- Indexes for table `assign_request_materials`
--
ALTER TABLE `assign_request_materials`
  ADD PRIMARY KEY (`assign_request_material_id`);
...
--
-- Indexes for table `labour_requests`
--
ALTER TABLE `labour_requests`
  ADD PRIMARY KEY (`labour_request_id`);
...
--
ALTER TABLE `asset_requests`
  MODIFY `vehicle_types_request_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `assign_request_materials`
--
ALTER TABLE `assign_request_materials`
  MODIFY `assign_request_material_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `conflicts`
  MODIFY `conflict_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `conflicts_media`
--
ALTER TABLE `conflicts_media`
  MODIFY `conflict_media_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `labour_requests`
--
ALTER TABLE `labour_requests`
  MODIFY `labour_request_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `material_requests`
  MODIFY `material_request_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
