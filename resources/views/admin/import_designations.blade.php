            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ $prefix.'/designations-list' }}" class="btn btn-success btn-sm pull-right">Back</a> &nbsp;
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ $prefix.'/designations-import' }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div>
                                ...
                                <a href="{{ $prefix.'/export-designations' }}" class="btn btn-danger m-2 float-right">Download Sample Template</a>
                            </div>
                        </form>
                        ...
                        <div style="color: red;">
                            ...
                            <ul>
                                ...
                                <li>
                                 <p>   Row {{ $failure->row() }}: {{ $failure->errors()[0] }} </p>
                                </li>
                                @endforeach
                            </ul>
                        </div>
