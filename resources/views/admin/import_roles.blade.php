...
<div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ $prefix.'/roles-list' }}" class="btn btn-success btn-sm pull-right">Back</a> &nbsp;
    ...
    <form action="{{ $prefix.'/roles-import' }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            ...
            <a href="{{ $prefix.'/export-roles' }}" class="btn btn-danger m-2 float-right">Download Sample Template</a>
        </div>
    </form>
                    </div>
                </div>
