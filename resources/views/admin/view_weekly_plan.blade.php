            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ $prefix . '/weekly-plan' . '?site_id=' . $site_id.'&chainage_id='.$chainage_id }}" class="btn btn-success btn-sm pull-right">Back</a> &nbsp;
                        ...
                        <div class="card-body">
                            <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                        <div class="section form-group">
                                            <label for="chainage-list">Chainage List:</label>
                                                        ...
                                                        <span>(</span>
                                                        @if($weeklyplan_data[0]['from_length']=='0' || !empty($weeklyplan_data[0]['from_length']))
                                                        {{$weeklyplan_data[0]['from_length']}} -
                                                    @endif

                                                    @if($weeklyplan_data[0]['to_length'])
                                                        {{ $weeklyplan_data[0]['to_length'] }}
                                                    @endif

                                                    @if($weeklyplan_data[0]['road_chainage_foundation_height'])
                                                        {{ $weeklyplan_data[0]['road_chainage_foundation_height'] }} -
                                                    @endif

                                                    @if($weeklyplan_data[0]['road_chainage_pier_height'])
                                                            {{ $weeklyplan_data[0]['road_chainage_pier_height'] }} -
                                                    @endif

                                                    @if($weeklyplan_data[0]['road_chainage_pier_cap_height'])
                                                            {{ $weeklyplan_data[0]['road_chainage_pier_cap_height'] }}
                                                    @endif

                                                    @if($weeklyplan_data[0]['road_chainage_max_elevation_height'])
                                                            {{ $weeklyplan_data[0]['road_chainage_max_elevation_height'] }} -
                                                    @endif

                                                    @if($weeklyplan_data[0]['road_chainage_max_depth_at_center'])
                                                            - {{ $weeklyplan_data[0]['road_chainage_max_depth_at_center'] }}
                                                    @endif

                                                    @if($weeklyplan_data[0]['road_chainage_width'])
                                                            {{ $weeklyplan_data[0]['road_chainage_width'] }} -
                                                    @endif

                                                    @if($weeklyplan_data[0]['road_chainage_thickness'])
                                                            {{ $weeklyplan_data[0]['road_chainage_thickness'] }}
                                                    @endif


                                                    @foreach ( $weeklyplan_data as $data)
                                                        @if($chainage_id_decoded==$data['chainage_id'])
                                                            @if($data['chainage_height'])
                                                                - {{$data['road_chainage_height']}}
                                                            @endif
                                                        @endif

                                                        @if($chainage_id_decoded==$data['chainage_id'])
                                                                @if(count($data['extrafields'])>0)
                                                                    @foreach ( $data['extrafields'] as $extra)
                                                                - {{$extra['chainage_extra_field_quanity']}}
                                                                    @endforeach
                                                                @endif
                                                        @endif
                                                    @endforeach
                                                    <span>)</span>
                                            <input type="text" class="form-control" value="{{$weeklyplan_data[0]['component_name'] }} " disabled>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                        <div class="section form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{date('d-m-Y',strtotime($weeklyplan_data[0]['plan_start_date'])) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                        <div class="section form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{date('d-m-Y',strtotime($weeklyplan_data[0]['plan_end_date'])) }}" disabled>
                                        </div>
                                    </div>
                                                {{-- <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                            <div class="section form-group">
                                ...
                                @if(!empty($weeklyplan_data))
                                        ...
                                        @foreach ( $weeklyplan_data as $data)
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            ...
                                                                            <input class="form-control" type="number" id="chainage-from" name="chainage_from" value="{{$data['chainage_from_length']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            ...
                                                                            <input class="form-control" type="number" id="chainage-to" name="chainage_to" value="{{$data['chainage_to_length']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage-to">Height (Max {{$data['road_chainage_height']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_height" name="chainage_height" value="{{$data['chainage_height']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage-to">Foundation Height (Max {{$data['road_chainage_foundation_height']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_foundation_height" name="chainage_foundation_height" value="{{$data['chainage_foundation_height']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage_pier_height">Pier Height (Max {{$data['road_chainage_pier_height']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_pier_height" name="chainage_pier_height" value="{{$data['chainage_pier_height']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage_pier_cap_height">Pier Cap Height (Max {{$data['road_chainage_pier_cap_height']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_pier_cap_height" name="chainage_pier_cap_height" value="{{$data['chainage_pier_cap_height']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage_max_elevation_height">Max Elevation Height (Max {{$data['road_chainage_max_elevation_height']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_max_elevation_height" name="chainage_max_elevation_height" value="{{$data['chainage_max_elevation_height']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage_max_depth_at_center">Max Depth At Center (Max {{$data['road_chainage_max_depth_at_center']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_max_depth_at_center" name="chainage_max_depth_at_center" value="{{$data['chainage_max_depth_at_center']}}" disabled>
                                                                ...
                                                                @if($data['chainage_width'])
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage_width">Width (Max {{$data['road_chainage_width']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_width" name="chainage_width" value="{{$data['chainage_width']}}" disabled>
                                                                ...
                                                                @if($chainage_id_decoded==$data['chainage_id'])
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            <label for="chainage_thickness">Thickness (Max {{$data['road_chainage_thickness']}} in METERS) : </label>
                                                                            <input class="form-control" type="number" id="chainage_thickness" name="chainage_thickness" value="{{$data['chainage_thickness']}}" disabled>
                                                    ...
                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                        ...
                                                        <div class="section form-group">
                                                            <label for="chainage_thickness">{{$extra['field_name']}} (Max {{$extra['chainage_extra_field_quanity']}} in {{$extra['unit_name']}}): </label>
                                                                <input class="form-control" type="number" id="{{$extra['site_weekly_plan_extra_field_id']}}" name="extra[]" value="{{$extra['quantity']}}" disabled>
                                ...
                                @endif
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                        <div class="section form-group">
                                            <label for="activity-list">Activity:</label>
                                            <input class="form-control" type="text" id="activity-list" name="activity_list" style="width: 100%;" value="{{$weeklyplan_data[0]['activity_name']}}" disabled>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                        <div class="section form-group">
                                            ...
                                            <label><input class="" type="radio" name="options" id="all"  {{$weeklyplan_data[0]['plain_or_lhs_rhs']==1?'checked':''}}  disabled ="1" > Regular</label>
                                            <label><input class="" type="radio" name="options" id="lhs_rhs" {{$weeklyplan_data[0]['plain_or_lhs_rhs']==2?'checked':''}}  disabled  value="2"> LHS and RHS</label>
                                        </div>
                                    </div>
                            </div>

                                {{-- All DIV Start --}}
                                @if($weeklyplan_data[0]['plain_or_lhs_rhs']==1)
                                        ...
                                        <div class="container">
                                            <div id="all-div" >
                                                ...
                                                <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(238, 226, 162);">
                                                    @foreach ($weeklyplan_data[0]['materials'] as $material_row)
                                                    <div id="material-rows">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    @if($material_row['plain_or_lhs_rhs']==1)
                                                                    <label for="material-name">Material Name:</label><br>
                                                                    <input class="form-control" type="text" id="chainage_thickness" name="chainage_thickness" value="{{$material_row['material_name']}} (Unit-{{$material_row['unit_name']}})" disabled>
                                                                    @endif
                                                                ...
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                    <div class="section form-group">
                                                                        ...
                                                                        <input type="number" class="material-quantity form-control" name="material_quantity[]" value="{{$material_row['material_quantity']}}" disabled>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(213, 243, 180);">
                                                    @foreach ($weeklyplan_data[0]['machines'] as $machines_row)
                                                    <div id="machine-rows">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    @if($machines_row['plain_or_lhs_rhs']==1)
                                                                    <label for="machine-name">Machine Name:</label><br>
                                                                    <input class="form-control" type="text" id="machine-name" name="machine_name[]" value="{{$machines_row['asset_name']}}" disabled>
                                                                    @endif
                                                            ...
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    ...
                                                                    <input type="number" class="machine-quantity form-control" name="machine_quantity[]" value="{{$machines_row['machine_quantity']}}" disabled>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            {{-- <div class="float-end my-4">
                                                ...
                                                <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(223, 242, 243);">
                                                    @foreach ($weeklyplan_data[0]['labours'] as $labours_row)
                                                    <div id="labours-rows">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    @if($labours_row['plain_or_lhs_rhs']==1)
                                                                    <label for="labours-name">Labours Type:</label><br>
                                                                    <input class="form-control" type="text" id="labours-name" name="labours_name[]" value="{{$labours_row['labour_type']}}" disabled>
                                                                    @endif
                                                            ...
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    ...
                                                                    <input type="number" class="labours-quantity form-control" name="labours_quantity[]" value="{{$labours_row['labour_quantity']}}" disabled>
                                                                    @endif
                                                                </div>
                                                            </div>
                                ...
                                @if($weeklyplan_data[0]['plain_or_lhs_rhs']==2)
                                    ...
                                    <div id="lhs_rhs-div">
                                        ...
                                        <label><input type="checkbox" id="rhs" name="lhs_and_rhs[]" value="2"> RHS</label> --}}
                                            ...
                                            <label><input class="" type="radio" name="lhs_and_rhs" id="lhs" {{$weeklyplan_data[0]['lhs_rhs_both']==1?'checked':''}} disabled value="1"> LHS</label>
                                            <label><input class="" type="radio" name="lhs_and_rhs" id="rhs" {{$weeklyplan_data[0]['lhs_rhs_both']==2?'checked':''}} disabled value="2"> RHS</label>
                                            <label><input class="" type="radio" name="lhs_and_rhs" id="both" {{$weeklyplan_data[0]['lhs_rhs_both']==3?'checked':''}} disabled value="3"> Both</label>
                                        </div>
                                    </div>
                                @endif

                                {{-- LHS DIV Start --}}
                                @if($weeklyplan_data[0]['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==1 || $weeklyplan_data[0]['lhs_rhs_both']==3))
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                            <div class="section form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="{{date('d-m-Y',strtotime($weeklyplan_data[0]['lhs_start_date'])) }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                            <div class="section form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="{{date('d-m-Y',strtotime($weeklyplan_data[0]['lhs_end_date'])) }}" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(238, 226, 162);">
                                                        ...
                                                        <div id="material-rows2">
                                                            <div class="row">
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                    <div class="section form-group">
                                                                        @if($material_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==1 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $material_row['lhs_or_rhs_material']==1)
                                                                            <label for="material-name2">Material Name:</label><br>
                                                                            <input class="form-control  material-name2" type="text" id="material-name2" name="material_name2[]" value="{{$material_row['material_name']}} (Unit-{{$material_row['unit_name']}})" disabled>
                                                                        @endif

                                                                        {{-- <select class="form-control select2 material-name2" id="material-name2" name="material_name2[]" style="width: 100%;">
                                                                        @foreach ($materials as $material_row)
                                                                        <option value="{{ $material_row['material_id'] }}">
                                                                        {{ $material_row['material_name'] }}</option>
                                                                        @endforeach
                                                                        </select> --}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                    <div class="section form-group">
                                                                        @if($material_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==1 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $material_row['lhs_or_rhs_material']==1)
                                                                            ...
                                                                            <input type="number" class="material-quantity2 form-control" name="material_quantity2[]" value="{{$material_row['material_quantity']}}" disabled>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                {{-- <div class="float-end my-4">
                                                    ...
                                                    <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(213, 243, 180);">
                                                        ...
                                                        <div id="machine-rows2">
                                                            <div class="row">
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                    <div class="section form-group">
                                                                        @if($machines_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==1 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $machines_row['lhs_or_rhs_machine']==1)
                                                                            <label for="machine-name2">Machine Name:</label><br>
                                                                            <input class="form-control" type="text" id="machine-name2" name="machine_name2[]" value="{{$machines_row['asset_name']}}" disabled>
                                                                        @endif
                                                                ...
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                    <div class="section form-group">
                                                                        ...
                                                                        @if($machines_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==1 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $machines_row['lhs_or_rhs_machine']==1)
                                                                                        ...
                                                                                        <input type="number" class="machine-quantity2 form-control" name="machine_quantity2[]" value="{{$machines_row['machine_quantity']}}" disabled>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                {{-- <div class="float-end my-4">
                                                    ...
                                                    <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(223, 242, 243);">
                                                        ...
                                                        <div id="labours-rows2">
                                                            <div class="row">
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                    <div class="section form-group">
                                                                        @if($labours_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==1 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $labours_row['lhs_or_rhs_labour']==1)
                                                                            <label for="labours-name2">Labours Type:</label><br>
                                                                            <input class="form-control" type="text" id="labours-name2" name="labours_name2[]" value="{{$labours_row['labour_type']}}" disabled>
                                                                        @endif
                                                                ...
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                    <div class="section form-group">
                                                                        ...
                                                                        <input type="number" class="labours-quantity2 form-control" name="labours_quantity2[]" value="{{$labours_row['labour_quantity']}}" disabled>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                {{-- <div class="float-end my-4">
                                ...
                                {{-- RHS DIV Start --}}
                                @if($weeklyplan_data[0]['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==2 || $weeklyplan_data[0]['lhs_rhs_both']==3))
                                    <div class="card m-2" style="">
                                        <div class="container">
                                            <div id="rhs-div" >
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                        <div class="section form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{date('d-m-Y',strtotime($weeklyplan_data[0]['rhs_start_date'])) }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                        <div class="section form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{date('d-m-Y',strtotime($weeklyplan_data[0]['rhs_end_date'])) }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach ($weeklyplan_data[0]['materials'] as $material_row)
                                                            <div id="material-rows3">
                                                                <div class="row">
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            @if($material_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==2 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $material_row['lhs_or_rhs_material']==2)
                                                                            <label for="material-name3">Material Name:</label><br>
                                                                            <input class="form-control" type="text" id="material-name3" name="material_name3[]" value="{{$material_row['material_name']}} (Unit-{{$material_row['unit_name']}})" disabled>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                        <div class="section form-group">
                                                                            @if($material_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==2 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $material_row['lhs_or_rhs_material']==2)
                                                                                ...
                                                                                <input type="number" class="material-quantity3 form-control" name="material_quantity3[]" value="{{$material_row['material_quantity']}}" disabled>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                    {{-- <div class="float-end my-4">
                                                ...
                                                <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(213, 243, 180);">
                                                    ...
                                                    <div id="machine-rows3">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    @if($machines_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==2 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $machines_row['lhs_or_rhs_machine']==2)
                                                                        <label for="machine-name3">Machine Name:</label><br>
                                                                        <input class="form-control" type="text" id="machine-name3" name="machine_name3[]" value="{{$machines_row['asset_name']}}" disabled>
                                                                    @endif
                                                            ...
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    @if($machines_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==2 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $machines_row['lhs_or_rhs_machine']==2)
                                                                                    ...
                                                                                    <input type="number" class="machine-quantity3 form-control" name="machine_quantity3[]" value="{{$machines_row['machine_quantity']}}" disabled>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            {{-- <div class="float-end my-4">
                                                ...
                                                <div class="card p-2" style="width: 100%; border-radius: 5px; background-color: rgb(223, 242, 243);">
                                                    ...
                                                    <div id="labours-rows3">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    @if($labours_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==2 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $labours_row['lhs_or_rhs_labour']==2)
                                                                        <label for="labours-name3">Labours Type:</label><br>
                                                                        <input class="form-control" type="text" id="labours-name3" name="labours_name3[]" value="{{$labours_row['labour_type']}}" disabled>
                                                                @endif
                                                            ...
                                                            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                                                <div class="section form-group">
                                                                    @if($labours_row['plain_or_lhs_rhs']==2 && ($weeklyplan_data[0]['lhs_rhs_both']==2 || $weeklyplan_data[0]['lhs_rhs_both']==3) && $labours_row['lhs_or_rhs_labour']==2)
                                                                            ...
                                                                            <input type="number" class="labours-quantity3 form-control" name="labours_quantity3[]" value="{{$labours_row['labour_quantity']}}" disabled>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            {{-- <div class="float-end my-4">
...
<script>
    $(document).ready(function() {
        ...
        //             html +=
        //                 `<option value="${loopArray[i].material_id}">${loopArray[i].material_name}</option>`;
        //         }
        //     } else if (className == 'machine') {
        //         for (let i = 0; i < loopArray.length; i++) {
