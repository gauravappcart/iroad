            ...
            <div class="col-sm-12">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><span class="text-success">Site Name</span> - <a href="{{$prefix.'/add-project-details?site_id='.$site_id}}"><span class="text-primary">{{ $site['site_name'] }}</span> </a> -Monitoring Activity List</h1>
                    </div>
                </div>
            </div>
            {{-- <div class="col-sm-8">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <br>
                        <button type="button" onclick="add_data()" class="btn btn-success btn-sm" data-toggle="modal" data-target="#scrollmodal"> Attach Tender Items To Monitoring Activity </button>
                    ...
                    <div class="card-body">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    <th>Sr.No</th>
                                    <th>Monitering Activity</th>
                                    <th>Activity Description</th>
                                    <th>Tender Item No.</th>
                                    <th>Monitoring Item(Tender Item)</th>
                                    <th>Monitoring Item Unit</th>
                                    <th>Created Date</th>
                                    <th>Updated Date</th>
                                    {{-- <th>Status</th>
                                    <th>Action</th> --}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       {{$data= $rowData['tender_item_id'] }},
                                        @endforeach
                                        {{-- {{array_column($value['associated_monitering_tenders'],'tender_item_id')}} --}}
                                    </td>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="page-title">
                            <h3><span class="text">Tender Items List</h3>
                        </div>
                    </div>
                    <div class="card-body">
...
// --------------------------------------------------------------------
    ...
    var tender_items = JSON.parse('<?php echo json_encode($activity_list) ?>');
