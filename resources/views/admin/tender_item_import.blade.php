            ...
            <div class="col-sm-12">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><span class="text-success">Site Name</span> - <a href="{{$prefix.'/add-project-details?site_id='.$site_id}}"><span class="text-primary">{{ $site['site_name'] }}</span> </a> -Import Tender Items</h1>
                    </div>
                </div>
            </div>
               {{--  <div class="col-sm-8">
...
<div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ $prefix.'/tender-item-list'.'?site_id='.$site_id.'&chainage_id='.$chainage_id }}" class="btn btn-success btn-sm pull-right">Back</a> &nbsp;
    ...
    <form action="{{ $prefix.'/import' }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            ...
            <a href="{{ $prefix.'/export' }}" class="btn btn-danger m-2 float-right">Download Sample Template</a>
        </div>
    </form>
                    </div>
                </div>
